/**
 * Application constants — single source of truth for offer name, company, etc.
 * Rename the offer by changing OFFER_NAME here (one line).
 */

export const OFFER_NAME = "AI Ledger Snapshot";
export const OFFER_SUBLINE = "What is your AI actually returning? A two-week independent read for companies up to ~1,000 people.";
...
export const ENGAGEMENT_DATE = "23/07/2026";
